                    ...
                    <div class="flex items-center">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-surface rounded-md shadow-lg py-1 z-50">
                                <a href="{{ route('profile') }}" class="block px-4 py-2 text-text hover:bg-primary/10">Profile</a>
                                <button disabled class="block w-full text-left px-4 py-2 text-text-muted cursor-not-allowed">
                                    Settings <span class="text-xs">(Coming Soon)</span>
                                </button>
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="block w-full text-left px-4 py-2 text-text cursor-pointer hover:bg-primary/10">
                                        Logout
                                    </button>
                                </form>
                            </div>
